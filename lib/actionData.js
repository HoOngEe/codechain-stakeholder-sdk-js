        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sdk.rpc.engine.getCustomActionData(index_1.HANDLER_ID, [
                        "Account",
                        classes_1.PlatformAddress.ensure(address)
                            .getAccountId()
                            .toEncodeObject()
                    ], blockNumber)];
                case 1:
                    data = _a.sent();
                    if (data == null) {
                        return [2 /*return*/, new classes_1.U64(0)];
                    }
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!util_1.isArrayOf(decoded, isValidatorShape)) {
                        throw new Error("Expected a rlp of Buffer[3][], but an invalid shaped value");
                    }
                    return [2 /*return*/, decoded.map(function (_a) {
                            var _b = __read(_a, 3), delegation = _b[0], deposit = _b[1], pubkey = _b[2];
                            return ({
